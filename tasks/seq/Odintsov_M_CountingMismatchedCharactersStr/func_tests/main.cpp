...
TEST(Odintsov_m_Sequential_count, ans_8) {
  // Create data
...
TEST(Odintsov_m_Sequential_count, ans_0) {
  // Create data
  char str1[] = "qwert";
  char str2[] = "qwert";
  std::vector<char*> in{str1, str2};
...
TEST(Odintsov_m_Sequential_count, ans_10) {
  // Create data
  char str1[] = "qwert";
...
TEST(Odintsov_m_Sequential_count, ans_11) {
  // Create data
  char str1[] = "qwerta";
  char str2[] = "asdfg";
...
TEST(Odintsov_m_Sequential_count, ans_22) {
  // Create data
  char str1[] = "qwertaqvsdfemm";
