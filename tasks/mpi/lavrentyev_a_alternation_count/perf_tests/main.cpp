...
TEST(mpi_lavrentyev_a_alternation_count, test_pipeline_run) {
  ...
  auto testMpiTaskParallel = std::make_shared<lavrentyev_a_alternation_count_mpi::TestMPITaskParallel>(taskDataPar);
...
TEST(mpi_lavrentyev_a_alternation_count, test_task_run) {
  boost::mpi::communicator world;
