...
class rams_s_radix_sort_with_simple_merge_for_doubles_mpi_test : public ::testing::TestWithParam<std::vector<double>> {
};

TEST_P(rams_s_radix_sort_with_simple_merge_for_doubles_mpi_test, p) {
  ...
  rams_s_radix_sort_with_simple_merge_for_doubles_mpi::TestMPITaskParallel test_task(task_data);
...
INSTANTIATE_TEST_SUITE_P(
  rams_s_radix_sort_with_simple_merge_for_doubles_mpi_test,
  rams_s_radix_sort_with_simple_merge_for_doubles_mpi_test,
  ::testing::Values(
    std::vector<double>{},
