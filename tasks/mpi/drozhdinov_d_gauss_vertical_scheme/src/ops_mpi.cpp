...
int drozhdinov_d_gauss_vertical_scheme_mpi::mkLinCoordddm(int x, int y, int xSize) { return y * xSize + x; }

double drozhdinov_d_gauss_vertical_scheme_mpi::myrnd(double value) {
