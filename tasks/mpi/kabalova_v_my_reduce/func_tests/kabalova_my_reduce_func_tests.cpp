...
TEST(kabalova_v_my_reduce, emptyVector) {
...
TEST(kabalova_v_my_reduce, sizeOneVector) {
  boost::mpi::communicator world;
...
TEST(kabalova_v_my_reduce, randomVecPlus) {
  boost::mpi::communicator world;
  size_t vecSize = 100;
  std::vector<int> vec = kabalova_v_my_reduce::generateRandomVector(vecSize, 0, 100);
  int answer = kabalova_v_my_reduce::plus(vec);
...
TEST(kabalova_v_my_reduce, randomVecProd) {
  boost::mpi::communicator world;
  size_t vecSize = 10;
  std::vector<int> vec = kabalova_v_my_reduce::generateRandomVector(vecSize, 0, 10);
  int answer = kabalova_v_my_reduce::multiply(vec);
...
TEST(kabalova_v_my_reduce, randomVecMax) {
  boost::mpi::communicator world;
  size_t vecSize = 100;
  std::vector<int> vec = kabalova_v_my_reduce::generateRandomVector(vecSize, -1000, 1000);
...
TEST(kabalova_v_my_reduce, randomVecMin) {
  boost::mpi::communicator world;
  size_t vecSize = 100;
  std::vector<int> vec = kabalova_v_my_reduce::generateRandomVector(vecSize, -1000, 1000);
...
TEST(kabalova_v_my_reduce, randomVecLand) {
  ...
  size_t vecSize = 100;
  std::vector<int> vec = kabalova_v_my_reduce::generateRandomVector(vecSize, 0, 100);
  int answer = kabalova_v_my_reduce::land(vec);
...
TEST(kabalova_v_my_reduce, randomVecLor) {
  boost::mpi::communicator world;
  size_t vecSize = 100;
  std::vector<int> vec = kabalova_v_my_reduce::generateRandomVector(vecSize, 0, 100);
  int answer = kabalova_v_my_reduce::lor(vec);
...
TEST(kabalova_v_my_reduce, randomVecLxor) {
  ...
  size_t vecSize = 100;
  std::vector<int> vec = kabalova_v_my_reduce::generateRandomVector(vecSize, 0, 100);
  int answer = kabalova_v_my_reduce::lxor(vec);
...
TEST(kabalova_v_my_reduce, randomVecBand) {
  boost::mpi::communicator world;
  size_t vecSize = 100;
  std::vector<int> vec = kabalova_v_my_reduce::generateRandomVector(vecSize, 0, 100);
  int answer = kabalova_v_my_reduce::band(vec);
...
TEST(kabalova_v_my_reduce, randomVecBor) {
  ...
  size_t vecSize = 100;
  std::vector<int> vec = kabalova_v_my_reduce::generateRandomVector(vecSize, 0, 100);
  int answer = kabalova_v_my_reduce::bor(vec);
...
TEST(kabalova_v_my_reduce, randomVecBxor) {
  boost::mpi::communicator world;
  size_t vecSize = 100;
  std::vector<int> vec = kabalova_v_my_reduce::generateRandomVector(vecSize, 0, 100);
  int answer = kabalova_v_my_reduce::bxor(vec);
