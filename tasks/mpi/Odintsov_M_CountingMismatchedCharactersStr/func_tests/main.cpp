...
TEST(Odintsov_m_Parallel_MPI_count, sz_1) {
  // Create data//
  boost::mpi::communicator com;
...
TEST(Odintsov_m_Parallel_MPI_count, sz_36) {
  // Create data//
  boost::mpi::communicator com;
...
TEST(Odintsov_m_Parallel_MPI_count, sz_24) {
  // Create data
  boost::mpi::communicator com;
  std::vector<int> out_s(1, 1);
...
TEST(Odintsov_m_Parallel_MPI_count, df_sz_15) {
  // Create data//
  boost::mpi::communicator com;
...
TEST(Odintsov_m_Parallel_MPI_count, sz_600) {
  // Create data
  boost::mpi::communicator com;
  std::vector<int> out_s(1, 1);
  std::string s1 = get_random_str(600);
  std::string s2 = get_random_str(600);
...
TEST(Odintsov_m_Parallel_MPI_count, sz_240) {
  ...
  boost::mpi::communicator com;
  std::vector<int> out_s(1, 1);
  std::string s1 = get_random_str(240);
  std::string s2 = get_random_str(240);
